...
public:
    ...
    private:
        ...
        Allocation(ListDoubleSidedTailed<Block>::Node* memoryBlock, T* data, Memory* owner) :
...
public:
    ...
    Memory(size_t size) : m_data(size), m_size(size), m_freeBlockAmount(1), m_usedBlockAmount(0)
    {
...
private:
    ...
    ListDoubleSidedTailed<Block>::Node* allocateBlockBestFit(size_t size, size_t alignment)
    {
