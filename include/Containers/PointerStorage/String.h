...
#include "Containers/PointerStorage/PointerContainers.h"
#include "Containers/PointerStorage/StringView.h"
...
namespace Containers 
{
	...
	public:
		using Container = Vector<CharType, Alloc, Life, s_initialCapacity, s_growthFactor>;
	...
	public:
		...
		StringViewBase<const T> subStr(size_t offset, size_t len) const {
