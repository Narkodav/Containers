#pragma once
#include "Containers/Utilities/ByteArray.h"
#include "Containers/Utilities/Concepts.h"
#include "Containers/Utilities/Macros.h"
...
#include "Containers/PointerStorage/InitializerList.h"
#include "Containers/PointerStorage/ContainerInterfaces.h"
#include "Containers/PointerStorage/Span.h"
...
namespace Containers
{
	...
	class Vector : public VectorContainerBase<T, size_t, Alloc>,
		...
		typename IteratorContainerInterface<Vector<T, Alloc, Life, s_initialCapacity, s_growthFactor>, T, size_t>::ConstIterator>
	{
		using Self = Vector<T, Alloc, Life, s_initialCapacity, s_growthFactor>;
		friend class SizedContainerInterface<Self, T, size_t,
		typename IteratorContainerInterface<Self, T, size_t>::Iterator,
		typename IteratorContainerInterface<Self, T, size_t>::ConstIterator>;
		friend class LifetimeManagedContainerInterface<Self, T, size_t, Life>;
