...
namespace Containers {
    ...
    template <AllocatorConcept<void> Allocator>
    class MemoryPool
    {
    public:
        ...
        private:
            ...
            Allocation(ListOneSided<Block>::Node* memoryBlock, T* data, MemoryPool* owner) :
    ...
    private:
        ...
        ListOneSided<Block>::Node* allocateBlockFirstFit(const size_t& size, const size_t& alignment)
        {
        ...
        ListOneSided<Block>::Node* allocateBlockBestFit(const size_t& size, const size_t& alignment)
        {
